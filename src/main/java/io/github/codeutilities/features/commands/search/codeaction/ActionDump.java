...
public class ActionDump implements Loadable {
    ...
    public void load() {
        try{
            JsonObject actionDump = WebUtil.getJSON(
                "https://raw.githubusercontent.com/CodeUtilities/data/main/actiondump/db.json").getAsJsonObject();
            ...
            types = WebUtil.getJSON("https://raw.githubusercontent.com/CodeUtilities/data/main/actiondump/types.json").getAsJsonObject();
        }catch(Exception e){
            e.printStackTrace();
        }
    }
