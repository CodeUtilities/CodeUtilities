...
import io.github.codeutilities.loader.v2.IManager;
import io.github.codeutilities.loader.v2.ISave;
...
public class TemplateStorageHandler implements IManager<TemplateItem>, ISave {
    ...
    private static final File FILE = FileUtil.cuFolder("Templates.nbt").toFile();
