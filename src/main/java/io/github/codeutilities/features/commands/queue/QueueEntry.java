package io.github.codeutilities.features.commands.queue;
...
public class QueueEntry {
    ...
    private final Regex ENTRY_PLOT_ID_REGEX = Regex.of("\\d{1,5}");
    ...
    public QueueEntry(String rawEntry, int i) {
        ...
        // Plot ID
        Matcher matcher = ENTRY_PLOT_ID_REGEX.getMatcher(description);
        while (matcher.find()) {
            try {
